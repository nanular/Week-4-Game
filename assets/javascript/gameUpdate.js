...
$("#terraImage").click (function() {
	if (!characterSelected) {
		...
		currentInitialAttack = fighters[currentCharacterIndex.attack];
...
$("#attackButton").click (function() {
		if (fighters[currentEnemyIndex].alive) {
			...
			fighters[currentCharacterIndex].attack = fighters[currentCharacterIndex].attack + currentInitialAttack;
